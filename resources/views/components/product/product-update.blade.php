                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-12 p-1">
                                ...
                                <select type="text" class="form-control form-select" id="productCategorieUpdate">
...
<script>
    ...
    async function UpdateFillCategorieDropDown(){
        let res = await axios.get("/list-categorie")
        res.data.forEach(function (item,i) {
            let option=`<option value="${item['id']}">${item['name']}</option>`
            $("#productCategorieUpdate").append(option);
        })
    }
    ...
    async function FillUpUpdateForm(id,filePath){
        ...
        showLoader();
        await UpdateFillCategorieDropDown();
        ...
        document.getElementById('productCategorieUpdate').value=res.data['categorie_id'];
    }


    async function update() {

        let productCategorieUpdate=document.getElementById('productCategorieUpdate').value;
        ...
        if (productCategorieUpdate.length === 0) {
            errorToast("Product Categorie Required !")
        }
            ...
            formData.append('categorie_id',productCategorieUpdate)
