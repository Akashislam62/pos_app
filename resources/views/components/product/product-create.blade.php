                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-12 p-1">
                                ...
                                <select type="text" class="form-control form-select" id="productCategorie">
...
<script>
    FillCategorieDropDown();
    async function FillCategorieDropDown(){
    ...
    async function Save() {
        ...
        let productCategorie=document.getElementById('productCategorie').value;
        ...
        if (productCategorie.length === 0) {
            ...
            formData.append('categorie_id',productCategorie)
